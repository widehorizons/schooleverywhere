...
class ReportCardIndex extends StatefulWidget {
  final String type;
  const ReportCardIndex(this.type);

  @override
  State<StatefulWidget> createState() {
    return new _ReportCardIndexState();
  }
}

class _ReportCardIndexState extends State<ReportCardIndex> {
  String? monValue;
  ...
  Future<void> syncMonthOptions() async {
    EventObject objectEventDate = await getMonthOptions(
        userSection!,
        userAcademicYear!,
        userSemester!,
        userStage!,
  ...
  Widget build(BuildContext context) {
    ...
    final goButton = Padding(
      ...
      child: RaisedButton(
        ...
        onPressed: () async {
          await launch(ReportCard.SCHOOL_REPORT_CARD_ONE_LINK +
              "?myyears=" +
              userAcademicYear! +
              "&regno=" +
              userRegno! +
