...
class CambridgeSupervisourAdvancedStaffConferenceState
    extends State<CambridgeSupervisourAdvancedStaffConference> {
  Staff? loggedStaff;
                    ...
                    ((element) => DataRow(
                          cells: <DataCell>[
                            ...
                            DataCell(
                              ...
                              onTap: () async {
                                await launch(ApiConstants.BASE_URL +
                                    "cambrigdeConference/JoinSupervisourCambridgeAdvancedOne.php?staffid=" +
                                    element["staffid"] +
                                    "&Sessionid=" +
                                    widget.sessionid +
                                    "&subject=" +
                            ...
                            DataCell(
                              ...
                              onTap: () async {
                                await launch(ApiConstants.BASE_URL +
                                    "cambrigdeConference/recordSupervisourCambridgeAdvancedOne.php?staffid=" +
                                    element["staffid"] +
                                    "&Sessionid=" +
                                    widget.sessionid +
                                    "&subject=" +
