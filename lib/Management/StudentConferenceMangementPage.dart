...
import 'StudentAdvancedConferennceJoin.dart';
import 'StudentConferennceJoin.dart';
import 'package:schooleverywhere/config/flavor_config.dart';

class StudentConferenceMangementPage extends StatefulWidget {
  String? type;
  String? sectionid;
  String? Id;
  String? Academicyear;

  StudentConferenceMangementPage(
      this.type, this.sectionid, this.Id, this.Academicyear);

  @override
  State<StatefulWidget> createState() {
    return new _StudentConferenceMangementPageState();
  }
}

class _StudentConferenceMangementPageState
    extends State<StudentConferenceMangementPage> {
  String? typeOptions;
  String? typename;
  ...
  Future<dynamic> homePageAllPages(String linkName, String type) async {
    if (linkName == "Conference") {
      return Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => StudentConferennceJoin()),
      );
    } else if (linkName == "advanced Conference") {
      return Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => StudentAdvancedConferennceJoin()),
      );
    }
  }
