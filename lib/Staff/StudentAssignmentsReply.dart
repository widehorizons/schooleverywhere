...
class StudentAssignmentsReplyFromStaff extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new _StudentAssignmentsReplyFromStaffState();
  }
}

class _StudentAssignmentsReplyFromStaffState
    extends State<StudentAssignmentsReplyFromStaff> {
  Staff? loggedStaff;
  ...
  Future<void> getLoggedInUser() async {
    ...
    syncStudentReplyAssignmentsShow();
  }

  Future<void> syncStudentReplyAssignmentsShow() async {
    EventObject objectEvents = new EventObject();
    objectEvents = await getStudentReplyAssignmentsFromStaff(
        StaffSectionId!,
        academicYearValue!,
        StaffStageId!,
        StaffGradeId!,
                                    ...
                                    DataCell(
                                      ...
                                      onTap: () {
                                        Navigator.push(
                                            ...
                                            new MaterialPageRoute(
                                                builder: (context) =>
                                                    StudentReplyAssignmentsFromStaffContent(
                                                        element["id"]
                                                            .toString())));
                                      },
                                    ),
