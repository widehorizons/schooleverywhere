...
class AdvancedStaffConferenceMangementPage extends StatefulWidget {
  ...
  const AdvancedStaffConferenceMangementPage(
      this.type, this.sectionid, this.Id, this.Academicyear);

  @override
  State<StatefulWidget> createState() {
    return new _AdvancedStaffConferenceMangementPageState();
  }
}

class _AdvancedStaffConferenceMangementPageState
    extends State<AdvancedStaffConferenceMangementPage> {
  String? typeOptions;
  String? typename;
  String? checkVersionCode, _projectCode;

  Future<dynamic> homePageAllPages(String linkName, String type) async {
    if (linkName == "Advanced Staff Confernce") {
      await launch(ApiConstants.BASE_URL +
          "conference/advancedConferenceStaffStaff.php?staff=" +
          widget.Id +
          "&section=" +
          userSection!);
    } else if (linkName == "Advanced Staff Join Conference") {
      return Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => AdvancedStaffJoinConference()),
      );
    } else if (linkName == "Advanced Staff Recorded Conference") {
      await launch(ApiConstants.BASE_URL +
          "conference/advancedConferenceStaffStaffRecord.php?staff=" +
          widget.Id +
          "&section=" +
          userSection!);
    } else if (linkName == "Advanced Other Staff Recorded") {
      await launch(ApiConstants.BASE_URL +
  ...
  Future<void> getLoggedInUser() async {
    loggedStaff = await getUserData() as Management;
