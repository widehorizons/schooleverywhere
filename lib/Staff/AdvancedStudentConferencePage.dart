...
class AdvancedStudentConferencePage extends StatefulWidget {
  String? type;
  String? sectionid;
  String? Id;
  String? Academicyear;

  AdvancedStudentConferencePage(
      this.type, this.sectionid, this.Id, this.Academicyear);

  @override
  State<StatefulWidget> createState() {
    return new _AdvancedStudentConferencePageState();
  }
}

class _AdvancedStudentConferencePageState
    extends State<AdvancedStudentConferencePage> {
  String? typeOptions;
  String? typename;
  String? checkVersionCode, _projectCode;

  Future<dynamic> homePageAllPages(String linkName, String type) async {
    if (linkName == "Create Conference") {
      return Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => createConferenceAdvanced()),
      );
    } else if (linkName == "Join Supervisour Advanced Conference") {
      return Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) =>
                AdvancedConferenceSupervisiorStaffJoinStaff()),
      );
    } else if (linkName == "Recorded Conference") {
      return Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => recoredConferenceAdvanced()),
      );
    }
  }
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    ...
                    if (!snapshot.hasData) {
                      ...
                      for (int i = 0; i < y.length; i++) {
                        ...
                        if (data['page'][i].toString() == "Create Conference") {
