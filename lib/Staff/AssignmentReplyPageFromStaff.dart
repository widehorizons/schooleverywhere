...
class AssignmentReplyPageFromStaff extends StatefulWidget {
  final String idAssignment;
  const AssignmentReplyPageFromStaff(this.idAssignment);
  @override
  State<StatefulWidget> createState() {
    return new _AssignmentReplyPageFromStaffState();
  }
}

class _AssignmentReplyPageFromStaffState
    extends State<AssignmentReplyPageFromStaff> {
  Staff? loggedStaff;
  ...
  File? filepath;
  String Url = ApiConstants.FILE_UPLOAD_REPLY_ASSIGNMENT_STAFF_API;
