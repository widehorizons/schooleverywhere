...
class StudentReplyAssignments extends StatefulWidget {
  final String type;
  const StudentReplyAssignments(this.type);
  @override
  State<StatefulWidget> createState() {
    return new _StudentReplyAssignmentsState();
  }
}

class _StudentReplyAssignmentsState extends State<StudentReplyAssignments> {
  Parent? loggedParent;
  ...
  Future<void> syncStudentReplyAssignmentsShow() async {
    ...
    objectEvents = await getStudentReplyAssignments(
        userSection!,
        userAcademicYear!,
        userStage!,
        userGrade!,
                                    ...
                                    DataCell(
                                      ...
                                      onTap: () {
                                        Navigator.push(
                                            ...
                                            new MaterialPageRoute(
                                                builder: (context) =>
                                                    StudentReplyAssignmentsContent(
                                                        element["id"]
                                                            .toString(),
                                                        widget.type)));
                                      },
