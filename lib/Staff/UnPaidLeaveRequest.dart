...
class UnPaidLeaveRequest extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return new _UnPaidLeaveRequestState();
  }
}

class _UnPaidLeaveRequestState extends State<UnPaidLeaveRequest> {
  Staff? loggedStaff;
  ...
  Future<void> syncAddUnPaidLeaveRequest() async {
    isLoading = true;
    if (date != null && timeFrom != null && timeTo != null) {
      EventObject objectEventAdd = await addUnPaidLeaveRequest(
          loggedStaff!.id!,
