...
class StudentAssignments extends StatefulWidget {
  final String type;
  const StudentAssignments(this.type);
  @override
  State<StatefulWidget> createState() {
    return new _StudentAssignmentsState();
  }
}
...
class _StudentAssignmentsState extends State<StudentAssignments> {
  ...
  Future<void> syncAssignmentsTeacher() async {
  ...
  Future<void> syncAssignmentsShow() async {
    EventObject objectEvents = new EventObject();
    if (widget.type == PARENT_TYPE) {
      objectEvents = await getAssignmentsShow(
          loggedParent!.childeSectionSelected,
          loggedParent!.academicYear,
          loggedParent!.stage,
          loggedParent!.grade,
