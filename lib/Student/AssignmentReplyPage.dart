...
class AssignmentReplyPage extends StatefulWidget {
  final String type;
  final String idAssignment;
  const AssignmentReplyPage(this.type, this.idAssignment);
  @override
  State<StatefulWidget> createState() {
    return new _AssignmentReplyPageState();
  }
}

class _AssignmentReplyPageState extends State<AssignmentReplyPage> {
  Parent? loggedParent;
  ...
  //     try {
  //       TempselectedFilesList = await FilePicker.platform
  ...
  //         TempselectedFilesList!.files
  //             .map((e) => selectedFilesList.add(File(e.path!)));
  //       selectedFilesList.add();
  //     });
  //   }
  // }
  void _openFileExplorer() async {
                          ...
                          for (int y = 0; y < selectedFilesList.length; y++) {
                            ...
                            try {
                              ...
                              Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => AssignmentReplyPage(
                                        widget.type, widget.idAssignment)),
                              );
                              /* Flushbar(
                          title: "Failed",
