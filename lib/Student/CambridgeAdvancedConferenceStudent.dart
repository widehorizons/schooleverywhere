...
class _CambridgeAdvancedConferenceStudentState extends State<CambridgeAdvancedConferenceStudent> {
  ...
  Future<void> _getMessages() async {
    EventObject objectEventMessageData = await getCambridgeStudentConferenceData(
    ...
    final showData = SingleChildScrollView(
      ...
      child: DataTable(
        columns: [
                ...
                DataColumn(label: Text("Conference",style: TextStyle(color: AppTheme.appColor, fontSize: 16),)),
                ...
                ((element) => DataRow(
                  cells: <DataCell>[
                    ...
                    DataCell(
                      ...
                      onTap: () async {
                        await launch(
                            ApiConstants.BASE_URL+"cambrigdeConference/advancedConferenceOneStudent.php?staffid="+element["staffid"]+"&Sessionid="+widget.sessionid+"&subject="+element["subjectid"]+"&sectionid="+userSection!+"&semister="+usersemester!+"&stage="+userstage!+"&grade="+usergrade!+"&class="+userclass!+"&year="+userAcademicYear!+"&regno="+childId!);
                      },
                    ),
                    DataCell(
                      ...
                      onTap: () async {
                        await launch(
                            urlConference!+"/demo/getrecordingstudent.jsp?meetingID="+ApiConstants.ConferenceSchoolName+"Schooleverywhere"+element["staffid"]+element["subjectid"]+widget.sessionid);
                      },
                    ),
                  ],
                )),
