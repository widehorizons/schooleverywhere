...
class ReportCardIndex4LandScape extends StatefulWidget {
  final String type;
  const ReportCardIndex4LandScape(this.type);

  @override
  State<StatefulWidget> createState() {
    return new _ReportCardIndex4LandScapeState();
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    final goButton = Padding(
      ...
      child: RaisedButton(
        ...
        onPressed: () async {
          await launch(ReportCard.SCHOOL_REPORT_CARD_FOUR_LAND_SCAPE_LINK +
              "?myyears=" +
              userAcademicYear +
              "&regno=" +
              userRegno +
