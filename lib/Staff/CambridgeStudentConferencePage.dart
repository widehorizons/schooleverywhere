...
class CambridgeStudentConferencePage extends StatefulWidget {
  ...
  CambridgeStudentConferencePage(
      this.type, this.sectionid, this.Id, this.Academicyear);

  @override
  State<StatefulWidget> createState() {
    return new _CambridgeStudentConferencePageState();
  }
}

class _CambridgeStudentConferencePageState
    extends State<CambridgeStudentConferencePage> {
  String? typeOptions;
  String? typename;
  ...
  Future<dynamic> homePageAllPages(String linkName, String type) async {
    int type;
    if (linkName == "Conference Cambridge") {
      type = 1;
      return Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => staffcambridgeConference(type)),
      );
    } else if (linkName == "Join Supervisour Conference Cambridge") {
      type = 2;
      return Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => staffcambridgeConference(type)),
