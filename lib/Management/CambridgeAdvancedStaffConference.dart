...
//    getUrlConference();
  ...
  Future<void> _getMessages() async {
    EventObject objectEventMessageData = await getCambridgeAdvancedConferenceStaffData(
                ...
                ((element) => DataRow(
                  cells: <DataCell>[
                    ...
                    DataCell(
                      ...
                      onTap: () async {
                        await launch(
                            ApiConstants.BASE_URL+"cambrigdeConference/advancedConferenceOne.php?staffid="+element["staffid"]+"&Sessionid="+widget.sessionid+"&stubject="+element["subjectid"]+"&sectionid="+userSection!+"&managementid="+userId!);
                      },
                    ),
                    DataCell(
                      ...
                      onTap: () async {
                        await launch(
                            ApiConstants.BASE_URL+"cambrigdeConference/recordConferenceOne.php?staffid="+element["staffid"]+"&Sessionid="+widget.sessionid+"&stubject="+element["subjectid"]+"&sectionid="+userSection!+"&managementid="+userId!);
                      },
                    ),
                  ],
                )),
