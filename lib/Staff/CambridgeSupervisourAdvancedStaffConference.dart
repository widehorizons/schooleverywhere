...
class CambridgeSupervisourAdvancedStaffConference extends StatefulWidget {
  final String sessionid;
  const CambridgeSupervisourAdvancedStaffConference(this.sessionid);

  @override
  State<StatefulWidget> createState() {
    return new CambridgeSupervisourAdvancedStaffConferenceState();
  }
}


class CambridgeSupervisourAdvancedStaffConferenceState extends State<CambridgeSupervisourAdvancedStaffConference> {
  ...
  Future<void> _getMessages() async {
    EventObject objectEventMessageData = await getCambridgeAdvancedConferenceSupervisourData(widget.sessionid,userSection!,userAcademicYear!,userId!);
            ...
            ((element) => DataRow(
              cells: <DataCell>[
                ...
                DataCell(
                  ...
                  onTap: () async {
                    await launch(
                        ApiConstants.BASE_URL+"cambrigdeConference/JoinSupervisourCambridgeAdvancedOne.php?staffid="+element["staffid"]+"&Sessionid="+widget.sessionid+"&subject="+element["subjectid"]+"&sectionid="+userSection!);
                  },
                ),
                DataCell(
                  ...
                  onTap: () async {
                    await launch(
                        ApiConstants.BASE_URL+"cambrigdeConference/recordSupervisourCambridgeAdvancedOne.php?staffid="+element["staffid"]+"&Sessionid="+widget.sessionid+"&subject="+element["subjectid"]+"&sectionid="+userSection!);
                  },
                ),
              ],
            )),
