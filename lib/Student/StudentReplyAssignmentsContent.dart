...
class StudentReplyAssignmentsContent extends StatefulWidget {
  dynamic id;
  final String type;
  StudentReplyAssignmentsContent(this.id, this.type);
  @override
  State<StatefulWidget> createState() {
    return new _StudentReplyAssignmentsContentState();
  }
}

class _StudentReplyAssignmentsContentState
    extends State<StudentReplyAssignmentsContent> {
  Map DataRec = new Map();
  dynamic attachment;
  ...
  Future<void> getData() async {
    EventObject eventObject =
        await getStudentReplyAssignmentsContent(widget.id.toString());
  ...
  Widget build(BuildContext context) {
    ...
    final body = Padding(
      ...
      child: Center(
        child: FutureBuilder(
          future: getStudentReplyAssignmentsContent(widget.id.toString()),
