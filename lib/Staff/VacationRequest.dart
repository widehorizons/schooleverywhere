...
import 'PreviousVacationRequest.dart';

class VacationRequest extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new _VacationRequestState();
  }
}
...
class _VacationRequestState extends State<VacationRequest> {
  ...
  Future<void> syncAddVacationRequest() async {
    isLoading = true;
    if (dateFrom != null && dateTo != null) {
      EventObject objectEventAdd = await addVacationRequest(
          loggedStaff!.id!,
