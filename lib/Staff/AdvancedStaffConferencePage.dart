...
class AdvancedStaffConferencePage extends StatefulWidget {
  final String type;
  final String sectionid;
  final String Id;
  final String Academicyear;

  const AdvancedStaffConferencePage(
      this.type, this.sectionid, this.Id, this.Academicyear);

  @override
  State<StatefulWidget> createState() {
    return new _AdvancedStaffConferencePageState();
  }
}

class _AdvancedStaffConferencePageState
    extends State<AdvancedStaffConferencePage> {
  String? typeOptions;
  String? typename;
  String? checkVersionCode, _projectCode;

  Future<dynamic> homePageAllPages(String linkName, String type) async {
    if (linkName == "Advanced Staff Conference") {
