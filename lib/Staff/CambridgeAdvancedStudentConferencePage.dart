...
class CambridgeAdvancedStudentConferencePage extends StatefulWidget {
  final String type;
  final String sectionid;
  final String Id;
  final String Academicyear;

  const CambridgeAdvancedStudentConferencePage(
      this.type, this.sectionid, this.Id, this.Academicyear);

  @override
  State<StatefulWidget> createState() {
    return new _CambridgeAdvancedStudentConferencePageState();
  }
}

class _CambridgeAdvancedStudentConferencePageState
    extends State<CambridgeAdvancedStudentConferencePage> {
  String? typeOptions;
  String? typename;
  ...
  Future<dynamic> homePageAllPages(String linkName, String type) async {
    int type;
    if (linkName == "Create Conference Cambridge") {
      type = 3;
      return Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => staffcambridgeConference(type)),
      );
    } else if (linkName == "Join Supervisour Advanced Conference Cambridge") {
      type = 4;
      return Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => staffcambridgeConference(type)),
