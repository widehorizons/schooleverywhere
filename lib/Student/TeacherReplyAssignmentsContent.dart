...
class TeacherReplyAssignmentsContent extends StatefulWidget {
  dynamic id;
  final String type;
  TeacherReplyAssignmentsContent(this.id, this.type);
  @override
  State<StatefulWidget> createState() {
    return new _TeacherReplyAssignmentsContentState();
  }
}

class _TeacherReplyAssignmentsContentState
    extends State<TeacherReplyAssignmentsContent> {
  Map DataRec = new Map();
  dynamic attachment;
  ...
  Future<void> getData() async {
    EventObject eventObject =
        await getTeacherReplyAssignmentsContent(widget.id.toString());
  ...
  Widget build(BuildContext context) {
    ...
    final body = Padding(
      ...
      child: Center(
        child: FutureBuilder(
          future: getTeacherReplyAssignmentsContent(widget.id.toString()),
