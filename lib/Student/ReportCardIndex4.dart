...
class ReportCardIndex4 extends StatefulWidget {
  final String type;
  const ReportCardIndex4(this.type);

  @override
  State<StatefulWidget> createState() {
    return new _ReportCardIndex4State();
  }
}

class _ReportCardIndex4State extends State<ReportCardIndex4> {
  String? monValue;
  ...
  Widget build(BuildContext context) {
    ...
    final goButton = Padding(
      ...
      child: RaisedButton(
        ...
        onPressed: () async {
          await launch(ReportCard.SCHOOL_REPORT_CARD_FOUR_LINK +
              "?myyears=" +
              userAcademicYear! +
              "&regno=" +
              userRegno! +
