...
class ReportCardIndex4WithBorder extends StatefulWidget {
  final String type;
  const ReportCardIndex4WithBorder(this.type);

  @override
  State<StatefulWidget> createState() {
    return new _ReportCardIndex4WithBorderState();
  }
}

class _ReportCardIndex4WithBorderState
    extends State<ReportCardIndex4WithBorder> {
  String? monValue;
  ...
  Widget build(BuildContext context) {
    ...
    final goButton = Padding(
      ...
      child: RaisedButton(
        ...
        onPressed: () async {
          await launch(ReportCard.SCHOOL_REPORT_CARD_FOUR_WITH_BORDER_LINK +
              "?myyears=" +
              userAcademicYear! +
              "&regno=" +
              userRegno! +
...
//          Navigator.pop(context);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(StringProperty('monValue', monValue));
  }
}
